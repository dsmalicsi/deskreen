          ...
          <Col xs={12} md={3}>
            ...
            {/*>*/}
              <Button
                minimal
                onClick={() => {
                  window.open('https://www.ordermo.ph', '_blank');
                }}
              >
                <Row middle="xs" style={{ opacity: '0.75' }}>
                  ...
                  <Col xs={8}>
                    <H5 style={{ marginBottom: '0px' }}>Screen Mirror</H5>
                  </Col>
                </Row>
              </Button>
            {/*</Tooltip>*/}
              ...
              >
                <Row start="xs">
                  ...
                  <Col xs>
                    ...
                    >
                      <Text>For internal use of Ordermo employees only.</Text>
                    </div>
                  </Col>
                </Row>
              </Button>
